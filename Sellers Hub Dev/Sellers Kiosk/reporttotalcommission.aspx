<%@ Page Language="VB"
    ...
    CodeFile="reporttotalcommission.aspx.vb"
    Inherits="reporttotalcommission"
    Title="Total Commission Report | Sellers' HUB"%>
                ...
                <div class="row-fluid">
                    <div class="box span12">
                        <div class="box-header well">
                            <h2>
                                <i class="icon-list-alt"></i>&nbsp;Total Commission Report</h2>
                        </div>
                        <div class="box-content form-horizontal">
                            <div class="alert alert-info">
                                This facility allows the user to either Print and/or Export the Total Commission Report to a PDF file.
                            </div> 
