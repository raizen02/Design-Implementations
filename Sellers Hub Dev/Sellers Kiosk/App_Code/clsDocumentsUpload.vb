...
'Program Name           : clsDocumentsUpload 
'Program Description    : Documents Re-Upload
'Form Name              :   
...
Public Class clsDocumentsUpload
...
#Region "Data Access"
    ...
    Public Function ExeCuteAko(ByVal _parenuCommandType As ExecuteCommand, _
                               ...
                               Optional ByRef _parstrDocumentType As String = "", _
        ...
        Try
            With _dimcmdMaintenance
                ...
                .CommandText = "SP_selOnlineDocumentsUpload_v2"
