...
#Region "Data Access"
    Public Function fnUsersProfile(ByVal _parenuCommandType As ExecuteCommand, _
                                   ByVal _parintMode As Integer, _
                                   ByVal _parstrUserName As String) As Boolean
        Dim _dimcmdUsersProfile As New SqlCommand

        Try
            With _dimcmdUsersProfile
                .Connection = Connection
                .Transaction = Transaction
                .CommandText = "sp_ssmProfile"
                .CommandType = CommandType.StoredProcedure
                .CommandTimeout = 0

                .Parameters.AddWithValue("@pintMode", _parintMode)
                .Parameters.AddWithValue("@pstrUserName", Trim(_parstrUserName))
                ...
                ElseIf _parenuCommandType = ExecuteCommand.ExecuteDataAdapter Then
                    ...
                    _prisdaDataAdapter.SelectCommand = _dimcmdUsersProfile
                End If
            End With
        ...
        Catch ex As Exception
            ...
            Return False
        Finally
            _dimcmdUsersProfile.Dispose()
            _dimcmdUsersProfile = Nothing
        End Try
    End Function
#End Region
