...
namespace Cti.Seller.Data.Data_Repositories
{
        public class DaoHelperMSSQL
        {
            ...
            public DaoHelperMSSQL()
            {

            }
            public DaoHelperMSSQL(string conn)
            {
                ConnString = conn;
            }
            ...
            public void SaveData(string[] Sql, SqlParameter[] Parameters, bool WithinTransaction)
            {
