...
var accountRegisterModule = angular.module('accountRegister', ['common'])
    .config(function ($routeProvider, $locationProvider) {
        $routeProvider.when(Seller.rootPath + 'account/register/step1', { templateUrl: Seller.rootPath + 'Templates/RegisterStep1.html', controller: 'AccountRegisterStep1ViewModel' });
        $routeProvider.when(Seller.rootPath + 'account/register/step2', { templateUrl: Seller.rootPath + 'Templates/RegisterStep2.html', controller: 'AccountRegisterStep2ViewModel' });
        $routeProvider.when(Seller.rootPath + 'account/register/step3', { templateUrl: Seller.rootPath + 'Templates/RegisterStep3.html', controller: 'AccountRegisterStep3ViewModel' });
        $routeProvider.when(Seller.rootPath + 'account/register/confirm', { templateUrl: Seller.rootPath + 'Templates/RegisterConfirm.html', controller: 'AccountRegisterConfirmViewModel' });
        $routeProvider.otherwise({ redirectTo: Seller.rootPath + 'account/register/step1' });
...
accountRegisterModule.controller("AccountRegisterViewModel", function ($scope, $http, $location, $window, viewModelHelper) {
    ...
    $scope.accountModelStep1 = new Seller.AccountRegisterModelStep1();
    $scope.accountModelStep2 = new Seller.AccountRegisterModelStep2();
    $scope.accountModelStep3 = new Seller.AccountRegisterModelStep3();
        ...
        if (viewModelHelper.modelIsValid) {
            viewModelHelper.apiPost('api/account/register/validate1', $scope.accountModelStep1,
                function (result) {
                    ...
                    $location.path(Seller.rootPath + 'account/register/step2');
                });
        }
        else
            viewModelHelper.modelErrors = $scope.accountModelStep1.errors;
...
accountRegisterModule.controller("AccountRegisterStep2ViewModel", function ($scope, $http, $location, viewModelHelper, validator) {
    ...
    if (!$scope.accountModelStep1.Initialized) {
        ...
        $location.path(Seller.rootPath + 'account/register/step1');
    }
        ...
        if (viewModelHelper.modelIsValid) {
            viewModelHelper.apiPost('api/account/register/validate2', $scope.accountModelStep2,
                function (result) {
                    ...
                    $location.path(Seller.rootPath + 'account/register/step3');
                });
        }
        else
            viewModelHelper.modelErrors = $scope.accountModelStep2.errors;
        ...
        if (viewModelHelper.modelIsValid) {
            viewModelHelper.apiPost('api/account/register/validate3', $scope.accountModelStep3,
                function (result) {
                    ...
                    $location.path(Seller.rootPath + 'account/register/confirm');
                });
        }
        else
            viewModelHelper.modelErrors = $scope.accountModelStep3.errors;
...
accountRegisterModule.controller("AccountRegisterConfirmViewModel", function ($scope, $http, $location, $window, viewModelHelper) {
    ...
    $scope.createAccount = function () {
        ...
        viewModelHelper.apiPost('api/account/register', accountModel,
            function (result) {
                //$location.path(Cti.Seller.rootPath);
                $window.location.href = Seller.rootPath;
            });
    }
});
