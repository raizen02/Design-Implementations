<%@ Page Language="VB"
    ...
    CodeFile="selPDFLoader.aspx.vb"
    Inherits="appSellersPage_selPDFLoader" %>
...
-->
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" mozdisallowselectionprint moznomarginboxes>
  <head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
    <meta name="google" content="notranslate">
    <title>PDF Loader | Sellers' HUB</title>
...
<link rel="resource" type="application/l10n" href="pdfjs/web/locale/locale.properties"/>
    ...
    <script type="text/javascript" src="pdfjs/web/viewer.cus.js"></script>
      ...
      <div id="mainContainer">
        ...
        <div id="secondaryToolbar" class="secondaryToolbar hidden doorHangerRight">
          <div id="secondaryToolbarButtonContainer">
            <button id="secondaryPresentationMode" class="secondaryToolbarButton presentationMode visibleLargeView" title="Switch to Presentation Mode" tabindex="19" data-l10n-id="presentation_mode" style="display: none">
              <span data-l10n-id="presentation_mode_label">Presentation Mode</span>
            </button>

            <button id="secondaryOpenFile" class="secondaryToolbarButton openFile visibleLargeView" title="Open File" tabindex="20" data-l10n-id="open_file" style="display: none">
            ...
            <a href="#" id="secondaryViewBookmark" class="secondaryToolbarButton bookmark visibleSmallView" title="Current view (copy or open in new window)" tabindex="23" data-l10n-id="bookmark" style="display: none">
